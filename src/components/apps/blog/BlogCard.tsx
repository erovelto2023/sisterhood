...
export default function BlogCard({ post, featured = false }: BlogCardProps) {
    if (featured) {
        return (
            <Link href={`/members/apps/blog/${post.slug}`} className="group block">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-sm">
                            <span className="px-3 py-1 bg-amber-100 text-amber-800 rounded-full font-medium text-xs uppercase tracking-wider">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 group-hover:text-amber-700 transition-colors leading-tight">
                            {post.title}
                        </h2>
    ...
    return (
        <Link href={`/members/apps/blog/${post.slug}`} className="group flex flex-col h-full">
